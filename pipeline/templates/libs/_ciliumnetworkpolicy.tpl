{{- define "libs.ciliumnetworkpolicy.tpl" -}}
{{- $all := index . 0 -}}
{{- $app := index . 1 -}}
{{- $v := index . 2 -}}

{{- range $name, $val := $v.ciliumnetworkpolicies }}
  {{- if kindIs "map" $val }}
...
{{- define "libs.ciliumnetworkpolicy" -}}
{{- $all := index . 0 -}}
{{- $app := index . 1 -}}
{{- include "helper.no.merge" (list $all $app "ciliumnetworkpolicy" ) -}}
{{- end -}}

{{- define "libs.ciliumnetworkpolicy.otherContainters" -}}
{{- include "helper.merge.otherContainters" (list . "ciliumnetworkpolicy" ) -}}
{{- end -}} 